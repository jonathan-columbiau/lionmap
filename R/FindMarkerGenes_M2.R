...
FindMarkerGenes_M2 = function(ref_bpcells, ref_metadata, tree, metadata_cluster_column = "cell_type", metadata_cell_id_column = "cellid",min_n_cells_sampled = 100, max_n_cells_sampled = 5000, p_val_threshold = .05) {
