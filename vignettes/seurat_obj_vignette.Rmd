...
Need to install the SeuratData package for the vignette/tutorial, alongside other dependencies. We're using it just because it has accessible datasets with classifications (stored in the Seurat metadata field!). Let us know if you have any issues accessing the data needed for this tutorial.
