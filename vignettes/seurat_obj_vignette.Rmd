...
The first step is to install dependencies (including SeuratData). We're using SeuratData just because it has accessible datasets with classifications (stored in the Seurat metadata field!). Let us know if you have any issues accessing the data needed for this tutorial.
